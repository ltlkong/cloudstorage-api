...
namespace ltl_cloudstorage.Migrations
{
    ...
    [Migration("20210912220231_UpdateDirectoryAddParentDir")]
    partial class UpdateDirectoryAddParentDir
    {
            ...
            modelBuilder.Entity("ltl_cloudstorage.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2021, 9, 12, 15, 2, 31, 334, DateTimeKind.Local).AddTicks(1111),
                            DisplayName = "public",
                            Email = "public@public.com",
                            LastLoginAt = new DateTime(2021, 9, 12, 15, 2, 31, 334, DateTimeKind.Local).AddTicks(1127),
                            MembershipId = 1,
                            Name = "public",
                            PasswordHash = "public"
                        },
            ...
            modelBuilder.Entity("ltl_cloudstorage.Models.UserInfo", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2021, 9, 12, 15, 2, 31, 334, DateTimeKind.Local).AddTicks(8515),
                            Introduction = "# Public test user",
                            Reputation = 100,
                            UpdatedAt = new DateTime(2021, 9, 12, 15, 2, 31, 334, DateTimeKind.Local).AddTicks(9649)
                        });
                });
