            ...
            modelBuilder.Entity("ltl_cloudstorage.Models.LtlDirectory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2021, 10, 5, 13, 9, 2, 606, DateTimeKind.Local).AddTicks(3954),
                            Name = "Default",
                            ProfileId = 1,
            ...
            modelBuilder.Entity("ltl_cloudstorage.Models.Profile", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2021, 10, 5, 13, 9, 2, 606, DateTimeKind.Local).AddTicks(340),
                            Introduction = "# Public test user",
                            Reputation = 100,
                            UpdatedAt = new DateTime(2021, 10, 5, 13, 9, 2, 606, DateTimeKind.Local).AddTicks(1465)
                        });
                });
            ...
            modelBuilder.Entity("ltl_cloudstorage.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2021, 10, 5, 13, 9, 2, 605, DateTimeKind.Local).AddTicks(9653),
                            DisplayName = "public",
                            Email = "public@public.com",
                            LastLoginAt = new DateTime(2021, 10, 5, 13, 9, 2, 605, DateTimeKind.Local).AddTicks(9673),
                            Name = "public",
                            PasswordHash = "public"
                        },
                        new
